import distillIconMask from "@/shared/assets/distill-icon-mask.png";
import { cn } from "@/shared/lib/cn";

/** Distill app mark — silhouette mask tinted with `currentColor`. */
export function DistillIcon({ className = "" }: { className?: string }) {
  return (
    <span
      role="img"
      aria-label="Distill"
      ...
      style={{
        WebkitMaskImage: `url(${distillIconMask})`,
        maskImage: `url(${distillIconMask})`,
