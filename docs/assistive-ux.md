...
Assistive UX is a product and architecture pattern for moments where Distill helps
...
The goal is not to add more tips. The goal is to make Distill attentive without
being intrusive:
