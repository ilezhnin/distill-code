...
- Required tests: <only where the lean-test policy warrants it - determinism/rollback, fail-loud contracts, content integrity, real-bug regressions - otherwise "none">
...
- Focused EditMode or PlayMode tests for the touched Unity contract pass.
